...
interface ScreeningRequestEmailProps {
  onNavigate: (page: Page) => void;
}

export function ScreeningRequestEmail({ onNavigate }: ScreeningRequestEmailProps) {
  return (
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="mb-6">
            ...
            <h1 style={{ 
              ...
              Referral Letter: Screening Request
            </h1>
          ...
          <div className="border-t pt-6" style={{ borderColor: 'var(--border)', backgroundColor: '#F9F9F9' }}>
            ...
            <div className="max-w-2xl mx-auto" style={{ 
              ...
              <h2 className="text-center mb-8" style={{
                ...
                SCS New Referral: Screening Request
              </h2>
              ...
              <div style={{ 
                ...
                <p className="mb-6">
                  We would like to refer the following client for {'{{ScreeningType}}'}. Kindly review and indicate if your team is able to proceed with the screening.
                </p>
