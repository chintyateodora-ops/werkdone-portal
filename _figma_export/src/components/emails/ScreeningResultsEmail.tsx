...
interface ScreeningResultsEmailProps {
  onNavigate: (page: Page) => void;
}

export function ScreeningResultsEmail({ onNavigate }: ScreeningResultsEmailProps) {
  return (
          ...
          <div className="border-t pt-6" style={{ borderColor: 'var(--border)', backgroundColor: '#F9F9F9' }}>
            ...
            <div className="max-w-2xl mx-auto" style={{ 
              ...
              <div style={{ 
                ...
                <p className="mb-6">
                  This is a reminder to submit the screening results for the following case:
                </p>
                ...
                {/* Thank you message */}
                <p className="mb-6">
                  Thank you for your continued cooperation in supporting timely client follow-up.
                </p>

                {/* Sign-off */}
                <p className="mb-1">Sincerely,</p>
                <p className="mb-6">Singapore Cancer Society</p>
                ...
                <p className="mb-4 text-center" style={{ color: '#6B7280' }}>
                  Please submit the results using the secure link below:
                </p>
