...
import { canonicalHealthierSgStored } from '../lib/healthierSgProfile';
...
export function buildDetailsFormDataForRow(row: MockProspectListRow): DetailsFormDataState {
  ...
  return {
    ...
    healthierSg: canonicalHealthierSgStored(x.healthierSg) || x.healthierSg,
