...
interface FollowUpTreatmentEmailProps {
  onNavigate: (page: Page) => void;
}

export function FollowUpTreatmentEmail({ onNavigate }: FollowUpTreatmentEmailProps) {
  return (
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="mb-6">
            ...
            <h1 style={{ 
              ...
              Follow-Up: Treatment Progress Update
            </h1>
          ...
          <div className="border-t pt-6" style={{ borderColor: 'var(--border)', backgroundColor: '#F9F9F9' }}>
            ...
            <div className="max-w-2xl mx-auto" style={{ 
              ...
              <h2 className="text-center mb-8" style={{
                ...
                SCS Follow-Up: Treatment Progress
              </h2>
              ...
              <div style={{ 
                ...
                <p className="mb-6">
                  We are reaching out to check on the treatment progress. Please review the updates and indicate any adjustments needed for the care plan.
                </p>
