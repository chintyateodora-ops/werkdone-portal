...
interface TreatmentRequestEmailProps {
  onNavigate: (page: Page) => void;
}

export function TreatmentRequestEmail({ onNavigate }: TreatmentRequestEmailProps) {
  return (
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="mb-6">
            ...
            <h1 style={{ 
              ...
              Referral Letter: Treatment Request
            </h1>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span style={{ 
                      ...
                      {'<noreply@cancertreatment.org.sg>'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span style={{ 
          ...
          <div className="border-t pt-6" style={{ borderColor: 'var(--border)', backgroundColor: '#F9F9F9' }}>
            ...
            <div className="max-w-2xl mx-auto" style={{ 
              ...
              <h2 className="text-center mb-8" style={{
                ...
                SCS New Referral: Treatment Request
              </h2>
              ...
              <div style={{ 
                ...
                <p className="mb-6">
                  We would like to refer the following client for cancer treatment. Kindly review and indicate if your team is able to proceed with the treatment.
                </p>
                ...
                <p className="mb-4 text-center" style={{ color: '#6B7280' }}>
                  Please use the secure link below to Accept or Reject this referral:
                </p>
